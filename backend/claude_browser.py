...
def _build_summary_prompt(transcript: str, title: str) -> str:
    return f"""你是一位專業的逐字稿摘要整理員。你的唯一任務是忠實整理以下逐字稿的內容，產出結構化摘要。

【核心原則：忠實於原始內容】
- 所有摘要內容必須直接來自逐字稿，不得加入任何逐字稿中未提及的觀點、數據、標的或建議
- 若某章節在逐字稿中無對應內容，請直接寫「本集未提及」，不要自行填充
- 用「創作者認為」、「節目中提到」等語氣，忠實呈現原創者的立場，而非以自己的角度詮釋
...
- 介紹產品、服務、課程，邀請訂閱或使用優惠碼
- 「今天節目由 XX 贊助」等話術
請完全忽略廣告內容，只針對實質投資討論進行摘要。

請用繁體中文產出以下格式的 Markdown 摘要：

## 核心觀點
（創作者在本集提出的 3-5 個主要論點或看法，用「創作者認為…」語氣呈現）

## 提及標的
（逐字稿中明確提及的股票、ETF、產業、市場；若未提及請寫「本集未提及具體標的」）

## 關鍵數據
（逐字稿中出現的具體數字、指標、時間點；若無請寫「本集未提及具體數據」）

## 創作者點出的機會
（創作者在本集中明確提到值得關注或可能有機會的方向；若未提及請寫「本集未明確提及」）

## 風險提示
（創作者提到的風險或需要注意的事項；若未提及請寫「本集未提及」）
