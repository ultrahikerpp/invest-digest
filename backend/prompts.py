...
- 保留主委的招牌比喻與口語（例如「關廁所」「越爛越噴」「朦朧美」這類用語），用引號標出
...
（依節目順序分 3-5 個主題章節。每個章節內用粗體小標帶出論點，每個論點後接 1-3 句說明，
保留主委的完整推理鏈：市場背景/事件 → 主委的判斷 → 理由與佐證 → 結論。
具體數字與提及標的直接寫進內文。每章節最多 5 個論點）
...
## 投資心法
（收錄本集主委講到的投資觀念、心態、紀律——不論出現在主題段落或 QA 段落都收錄於此，
